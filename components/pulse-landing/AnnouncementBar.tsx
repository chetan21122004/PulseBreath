...
export function AnnouncementBar() {
  return (
    <div
      className="relative flex h-[var(--header-disclaimer-height)] items-center border-b border-white/[0.07] bg-[linear-gradient(180deg,color-mix(in_oklch,var(--brand-deeper)_92%,var(--brand-teal)_8%)_0%,var(--brand-deeper)_100%)]"
    >
      <div
